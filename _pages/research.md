...
<style>
  .pub-container {
    margin-bottom: 0.8rem; /* Tightened space between entries */
    padding: 0.5rem 0.8rem; /* Tighter padding inside each entry */
    border-left: 3px solid rgba(128, 128, 128, 0.3);
    background-color: transparent;
    transition: all 0.2s ease;
  }
  /* Subtle highlight on hover that works beautifully in both light and dark modes */
  .pub-container:hover {
  ...
  .pub-title {
    font-weight: 600;
    font-size: 0.95rem; /* Slightly smaller for a sleeker look */
    line-height: 1.3;
    color: inherit; 
    display: block;
    margin-bottom: 2px;
  ...
  .pub-authors {
    font-size: 0.8rem; /* Compact author text */
    opacity: 0.8;
    margin-bottom: 2px;
  }
  .pub-venue {
    font-style: italic;
    font-size: 0.8rem; /* Compact venue text */
    opacity: 0.7;
    display: block;
    margin-bottom: 4px;
  }
  /* Flexbox Fix: Absolutely forces buttons to remain on the same line */
  .pub-links {
    display: flex;
    flex-wrap: nowrap; /* Prevents buttons from wrapping into a new line */
    gap: 6px; /* Uniform spacing between badges */
    align-items: center;
    margin-top: 2px;
  }
  .btn-pub {
    display: inline-block;
    padding: 1px 8px; /* Slimmer layout */
    font-size: 0.7rem; /* Tiny, clean text */
    font-weight: 600;
    border-radius: 3px;
...
<div class="pub-container">
  ...
  <div class="pub-links">
    ...
    <a href="https://doi.org/10.1016/j.scico.2024.103196" class="btn-pub btn-doi" target="_blank">DOI</a>
  </div>
</div>
...
<div class="pub-container">
  ...
  <div class="pub-links">
    ...
    <a href="https://doi.org/10.48550/arXiv.2506.05840" class="btn-pub btn-doi" target="_blank">arXiv</a>
  </div>
</div>
...
<div class="pub-container">
  ...
  <div class="pub-links">
    ...
    <a href="https://doi.org/10.1007/978-3-031-94748-3_9" class="btn-pub btn-doi" target="_blank">DOI</a>
  </div>
</div>
...
<div class="pub-container">
  ...
  <div class="pub-links">
    ...
    <a href="https://doi.org/10.1007/978-3-031-42441-0_1" class="btn-pub btn-doi" target="_blank">DOI</a>
  </div>
</div>
...
<div class="pub-container">
  ...
  <div class="pub-links">
    ...
    <a href="https://doi.org/10.1007/978-3-031-35257-7_20" class="btn-pub btn-doi" target="_blank">DOI</a>
  </div>
</div>
